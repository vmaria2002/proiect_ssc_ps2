...
HD_PWD='D:/An3/SSC/P_35/p_35_ps2 - Copy/p_35_ps2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys.tcl
