...
HD_PWD='D:/An3/SSC/P_35/p_35_ps2 - Copy/p_35_ps2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nexys.tcl -notrace
